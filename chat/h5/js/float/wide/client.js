    ...
    var bytedeskapp = new Vue({
        ...
        data() {
            return {
                ...
                // STOMP_HOST: 'https://api.bytedesk.com',
        ...
        methods: {
            ...
            is_type_text (message) {
                return message.type === 'text' || message.type === 'notification_thread'
            },
            ...
            is_type_notification (message) {
                return message.type !== 'notification_thread' && message.type.startsWith('notification')
            },
            player_url () {
            ...
            subscribeTopic(topic) {
                ...
                bytedeskapp.stompClient.subscribe('/topic/' + topic, function (message) {
                    ...
                    if (messageObject.user.uid === bytedeskapp.uid) {
                        return
                    }
                    if ((messageObject.type === 'text' ||
                        messageObject.type === 'image' ||
                        messageObject.type === 'file') &&
                        messageObject.user.uid !== bytedeskapp.uid) {
                        //
                        // 新protobuf转换json
            ...
            sendTextMessage () {
                ...
                if (this.isRobot) {
                    ...
                    var json = {
                        ...
                        "user": {
                            "uid": this.uid,
                            "nickname": this.thread.visitor.nickname,
