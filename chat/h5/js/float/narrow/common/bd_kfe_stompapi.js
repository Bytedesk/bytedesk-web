...
var bd_kfe_stompapi = {
    ...
    bd_kfe_data.stompClient.subscribe("/topic/" + topic, function (message) {
      ...
      if ((messageObject.type === "text"
        ...
        if (formContent.indexOf('邮箱') !== -1) {
          $("#byteDesk-form-email-div").show();
        }
        if (formContent.indexOf('年龄') !== -1) {
          $("#byteDesk-form-age-div").show();
        }
        if (formContent.indexOf('职业') !== -1) {
          $("#byteDesk-form-job-div").show();
        }
  ...
  sendFormMessage: function () {
    //
    var name = $.trim($("#byteDesk-form-name").val());
    var mobile = $.trim($("#byteDesk-form-mobile").val());
    var email = $.trim($("#byteDesk-form-email").val());
    var age = $.trim($("#byteDesk-form-age").val());
    var job = $.trim($("#byteDesk-form-job").val());
    ...
    $("#byteDesk-form-name-div").hide();
    $("#byteDesk-form-mobile-div").hide();
    $("#byteDesk-form-email-div").hide();
    $("#byteDesk-form-age-div").hide();
    $("#byteDesk-form-job-div").hide();
  },
  //
