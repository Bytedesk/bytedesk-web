...
var bd_kfe_utils = {
  ...
  pushToMessageArray: function(message) {
    ...
    if (bd_kfe_utils.is_type_notification(message)) {
      ...
      if (bd_kfe_utils.is_type_text(message)) {
        content += "<div class='text' id='content-" + message.mid + "'>" + 
        bd_kfe_utils.replaceFace(message.content) + 
        "</div>";
        content += "<div class='status' id='status-" + message.mid + "'></div>";
      } else if (bd_kfe_utils.is_type_image(message)) {
        content +=
          "<div class='text' id='content-" + message.mid + "'>" +
          "<img src='" +
          message.imageUrl +
  ...
  pushRightAnswerToMessageArray: function(message) {
    ...
    //
    var content = "<p class='timestamp'><span>" + message.createdAt + "</span><br/></p>";
    content += "<img class='avatar' width='30' height='30' src='" + message.user.avatar + "'/>";
    if (!bd_kfe_utils.is_self(message)) {
      content += "<div class='nickname'>" + message.user.nickname + "</div>";
    }
    // TODO: 添加 ‘有帮助’ 和 ‘无帮助’
    ...
    for (var j = 0; j < message.answers.length; j++) {
      var answer = message.answers[j];
      question += "<br/><span style='color:#007bff; cursor: pointer;' onclick='httpapi.queryAnswer(" + answer.aid + ")'>" + answer.question + "</span>";
    }
    //
    var isHelpfull = "<br/><span style='color:#007bff; cursor: pointer;' onclick='httpapi.rateAnswer(" + message.answer.aid + "," + message.mid + ",true)'>有帮助</span>" + 
      "<span style='color:#007bff; cursor: pointer; margin-left: 5px;' onclick='httpapi.rateAnswer(" + message.answer.aid + "," + message.mid + ",false)'>无帮助</span>";
    //
    content +=
      "<div class='text'>" +
      "<span>" + message.content + "</span>" +
  ...
  pushNoAnswerToMessageArray: function(message) {
    ...
    //
    var contactAgent = "<br/><span style='color:#007bff; cursor: pointer;' onclick='httpapi.requestAgent()'>人工客服</span>";
    //
    content +=
      "<div class='text'>" +
      "<span>" + message.content + "</span>" +
