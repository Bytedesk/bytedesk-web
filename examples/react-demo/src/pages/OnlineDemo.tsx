...
//       <Card title={`📘 ${messages.pages.onlineDemo.docLinksTitle}`} variant="outlined">
//         <List
//           dataSource={docLinks}
//           renderItem={(link) => (
//             <List.Item>
...
//       <Row gutter={24} wrap>
//         <Col xs={24} lg={16}>
//           <Card title={`✨ ${messages.pages.onlineDemo.feedbackSectionTitle}`} variant="outlined">
...
//         </Col>
//         <Col xs={24} lg={8}>
//           <Card title={`🎛️ ${messages.pages.onlineDemo.controlPanelTitle}`} variant="outlined">
