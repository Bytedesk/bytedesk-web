            ...
            <Space orientation="vertical" size="large" style={{ width: '100%' }}>
                ...
                <Card>
                    <Space orientation="vertical" size="large" style={{ width: '100%' }}>
                        <Statistic
                            ...
                            value={unreadCount}
                            styles={{ content: { color: token.colorError, fontSize: 36 } }}
                        />
                        <Space wrap>
                        ...
                        <Space orientation="vertical" size="small" style={{ width: '100%' }}>
                            ...
                            <Space wrap>
                                <Space.Compact>
                                    <Button disabled>{messages.pages.unreadCountDemo.manualCountLabel}</Button>
                                    <InputNumber
                                        min={0}
                        ...
                        <Alert
                            type="info"
                            showIcon
                            title={`${messages.common.apiHintPrefix} getUnreadMessageCount(), clearUnreadMessages(), setUnreadMessageCount(), showUnreadDot(), clearUnreadBadge()`}
                ...
                <Card title={messages.pages.unreadCountDemo.urlGuideTitle}>
                    <Space orientation="vertical" size="middle" style={{ width: '100%' }}>
                        ...
                        <div>
                            <Typography.Text strong>{messages.pages.unreadCountDemo.apiNotesTitle}</Typography.Text>
                            <ul style={{ margin: '8px 0 0', paddingLeft: 20, lineHeight: 1.8 }}>
                                {messages.pages.unreadCountDemo.apiNotes.map((item) => (
                                    <li key={item}>{item}</li>
                                ))}
                            </ul>
                        </div>
                ...
                <Card title={messages.pages.unreadCountDemo.usageNotesTitle} styles={{ body: { paddingBottom: 0 } }}>
                    <ul style={{ margin: 0, padding: '0 0 16px 20px', lineHeight: 1.8 }}>
                        {messages.pages.unreadCountDemo.usageNotes.map((note) => (
                            <li key={note} style={{ padding: '4px 0' }}>
