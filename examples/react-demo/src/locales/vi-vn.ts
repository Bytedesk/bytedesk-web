...
export const viVn = {
  ...
  pages: {
    ...
    goodsInfoDemo: {
      ...
      shopGoodsCardTitle: 'Cua hang & San pham (danh sach gon)',
      currentShopLabel: 'Cua hang hien tai',
      consultGoodsBtn: 'Tu van san pham nay',
      consultParamsLabel: 'Tham so tu van',
      goodsPayloadCardTitle: 'Payload san pham hien tai',
      goodsStringifyHint: 'Cach chuyen doi tuong san pham thanh chuoi va truyen vao cau hinh:',
      urlParamsCardTitle: 'Danh sach tham so URL hien tai',
      standaloneUrlLabel: 'URL cua so doc lap / tab moi',
      paramNameCol: 'Ten tham so',
      paramValueCol: 'Gia tri hien tai',
      paramPurposeCol: 'Mo ta',
      requiredLabel: 'Bat buoc',
      optionalLabel: 'Tuy chon',
      goodsUrlHint: 'Cach ghep tham so san pham vao URL:',
      urlParamPurposes: {
        org: 'Ma dinh danh to chuc (Org UID)',
        t: 'Loai phien: t=0 mot-mot, t=1 nhom lam viec, t=2 bot',
        sid: 'UID nhan vien / nhom / bot',
        visitorUid: 'Ma dinh danh duy nhat cua khach',
        nickname: 'Biet danh khach',
        avatar: 'URL anh dai dien khach',
        goodsInfo: 'Thong tin san pham (chuoi JSON), bao gom ten, anh, gia, lien ket. Can dung JSON.stringify truoc khi truyen vao',
        extra: 'Tham so mo rong tuy chinh (JSON)',
        lang: 'Ngon ngu giao dien',
        mode: 'Che do mau sac (light / dark / auto)',
      }
    },
    orderInfoDemo: {
      ...
      currentDemoUserLabel: 'Demo-user hien tai',
      orderListCardTitle: 'Danh sach don hang (gon)',
      currentUserLabel: 'Nguoi dung hien tai',
      currentIndicator: '[Hien tai]',
      noOrdersText: 'Khong co don hang cho nguoi dung nay',
      consultOrderBtn: 'Tu van don hang nay',
      anonymousNoOrderAlert: 'Nguoi dung an danh khong co du lieu don hang. Tu van se khong bao gom tham so don hang.',
      consultParamsLabel: 'Tham so tu van',
      orderPayloadCardTitle: 'Payload don hang hien tai',
      orderStringifyHint: 'Cach chuyen doi tuong don hang thanh chuoi va truyen vao cau hinh:',
      urlParamsCardTitle: 'Danh sach tham so URL hien tai',
      standaloneUrlLabel: 'URL cua so doc lap / tab moi',
      paramNameCol: 'Ten tham so',
      paramValueCol: 'Gia tri hien tai',
      ...
      requiredLabel: 'Bat buoc',
      optionalLabel: 'Tuy chon',
      orderUrlHint: 'Cach ghep tham so don hang vao URL:',
      urlParamPurposes: {
        org: 'Ma dinh danh to chuc (Org UID)',
        t: 'Loai phien: t=0 mot-mot, t=1 nhom lam viec, t=2 bot',
        sid: 'UID nhan vien / nhom / bot',
        ...
        nickname: 'Biet danh khach',
        avatar: 'URL anh dai dien khach',
        orderInfo: 'Thong tin don hang (chuoi JSON), bao gom ma don, san pham, so tien, dia chi. Can dung JSON.stringify truoc khi truyen vao',
        extra: 'Tham so mo rong tuy chinh (JSON)',
        lang: 'Ngon ngu giao dien',
        mode: 'Che do mau sac (light / dark / auto)',
      }
    ...
    unreadCountDemo: {
      ...
      manualTitle: 'Dieu khien huy hieu thu cong',
      manualCountLabel: 'Chua doc',
      currentBadgeMode: 'Che do huy hieu hien tai',
      badgeModes: {
        hidden: 'An',
        dot: 'Cham do',
        count: 'So luong'
      ...
      buttons: {
        ...
        applyManualCount: 'Dat so chua doc',
        showDot: 'Hien cham do',
        clearBadge: 'Xoa huy hieu'
      },
      usageNotesTitle: 'Meo',
      usageNotes: [
        'Su dung getUnreadMessageCount() bat cu khi nao ban can tong moi nhat.',
        'Goi clearUnreadMessages() sau khi khach da doc tin nhan.',
        'Dung setUnreadMessageCount(count) de dong bo tong so chua doc tu nghiep vu len nut noi.',
        'Dung showUnreadDot() khi chi can danh dau co tin moi ma khong can hien so cu the.',
        'Dung clearUnreadBadge() de xoa huy hieu ma khong can gui request mang.'
      ],
      ...
      manualCountApiLabel: 'API dat huy hieu so thu cong',
      showDotApiLabel: 'API hien cham do',
      clearBadgeApiLabel: 'API xoa huy hieu',
      ...
      apiNotes: [
        ...
        'setUnreadMessageCount(), showUnreadDot() va clearUnreadBadge() la API cuc bo cua widget, khong gui HTTP request.',
    ...
    callCenterDemo: {
      ...
      currentPathLabel: 'Duong dan hien tai',
      currentPathHint: 'Route van la /call; hang doi duoc xac dinh boi chatConfig.sid.',
      usageTitle: 'Ghi chu demo',
      usageNotes: [
    ...
    voiceAgentDemo: {
      ...
      description: 'Trang nay tham khao VoiceAgent trong du an visitor va minh hoa cach chuyen entry cua Bytedesk Web SDK truc tiep toi /chat/voice de trai nghiem tro ly giong noi toan man hinh.',
      bubbleTitle: 'Tro ly giong noi',
      bubbleSubtitle: 'Nhan giu de noi hoac chuyen sang nhap van ban',
      pathAlert: 'Trang nay dat chatPath thanh /chat/voice. Bam vao nut noi, goi showChat(), hoac mo URL truc tiep deu vao trang tro ly giong noi.',
      currentPathLabel: 'Duong dan entry hien tai',
      currentPathHint: 'Duong dan co dinh la /chat/voice; org / t / sid van xac dinh dich den hoi thoai.',
      anonymousUserHint: 'Che do an danh: khong truyen visitorUid, nickname, avatar',
      recommendedProfileNotice: 'Nen uu tien cau hinh bot de mo phong tro ly giong noi, nhung ban van co the dung org / t / sid hien tai cho muc tieu khac.',
      capabilityTitle: 'Tinh nang dong bo voi trang voice cua visitor',
      capabilityItems: [
        'Hien thi trang thai ready, connecting, listening, processing va error theo thoi gian thuc.',
        'Hai che do nhap: nhan giu de noi hoac chuyen sang nhap van ban lam phuong an du phong.',
        'Luong tin nhan hien thi noi dung nguoi dung, phan hoi AI va ban nhap dang tao cua tro ly.',
        'Lop phu ghi am hien muc am luong, thoi gian va huong dan thao tac.'
      ],
      usageTitle: 'Ghi chu demo',
      usageNotes: [
        '1. Giu htmlUrl la duong dan goc cua site va chi doi chatPath thanh /chat/voice.',
        '2. Nut noi van dung chat action nen khong can mo rong them SDK action moi.',
        '3. Popup, tab moi va widget iframe deu dung cung mot bo tham so URL.',
        '4. Nen truyen visitorUid / nickname / avatar de trang voice nhan dien duoc danh tinh khach.'
      ],
      urlGuideTitle: 'Huong dan URL + tham so',
      sampleUrlLabel: 'URL mau tu cau hinh hien tai',
      urlParamsTitle: 'Tham so',
      urlParams: [
        'org: ID to chuc (bat buoc)',
        't: loai hoi thoai (0: 1-1, 1: nhom lam viec, 2: bot)',
        'sid: ID dich den hoi thoai (nhan vien / nhom / bot)',
        'visitorUid: ID khach tuy chinh (nen dung)',
        'nickname / avatar: thong tin hien thi cua khach (tuy chon)',
        'lang: ngon ngu',
        'mode: che do giao dien (light / dark / system)',
        'navbar: co hien thanh dieu huong tren trang voice hay khong'
      ],
      buttons: {
        openVoiceAgent: 'Mo tro ly giong noi',
        switchAnonymousUser: 'Chuyen sang nguoi dung an danh'
      },
      docLinks: {
        reactDoc: 'Xem tai lieu tich hop React',
        vueDoc: 'Xem tai lieu tich hop Vue',
        reactExample: 'Ma nguon demo tro ly giong noi React'
      }
    },
