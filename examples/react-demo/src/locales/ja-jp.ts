  ...
  pages: {
    ...
    basicDemo: {
      ...
      intro: '下のクイックアクションで Bytedesk Web SDK の代表的な機能をすぐに試せます。',
        renderModeLabel: '表示モード',
        modeFloating: 'フローティング',
        modeInline: 'インライン埋め込み',
        modeSwitchWarning: 'モードを切り替えると SDK が再初期化されます。',
        inlineDemoTitle: 'インライン埋め込みデモ',
        inlineDemoMainContent: 'ここではホストページのメインコンテンツ領域を再現しています。',
