  ...
  pages: {
    ...
    basicDemo: {
      ...
      intro: 'Usa las acciones rapidas de abajo para probar las funciones comunes del SDK Web de Bytedesk.',
        ...
        modeInline: 'Integrado',
        modeSwitchWarning: 'Cambiar el modo volvera a inicializar el SDK.',
        inlineDemoTitle: 'Demo de integracion inline',
        inlineDemoMainContent: 'Esta area simula el contenido principal de la pagina anfitriona.',
