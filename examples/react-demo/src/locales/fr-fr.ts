  ...
  pages: {
    ...
    basicDemo: {
      ...
      intro: 'Utilisez les actions rapides ci-dessous pour tester les fonctions courantes du SDK Web Bytedesk.',
        renderModeLabel: 'Mode de rendu',
        modeFloating: 'Flottant',
        modeInline: 'Integre',
        modeSwitchWarning: 'Changer de mode reinitialisera le SDK.',
        inlineDemoTitle: 'Demo d integration inline',
        inlineDemoMainContent: 'Cette zone simule le contenu principal de la page hote.',
