<!--
 * @Description: Voice Agent Demo for Vue
-->
<template>
  <PageContainer>
    <div class="card">
      <h2>AI 语音客服演示</h2>
      <p class="desc">演示 AI 语音客服对话功能，使用 /chat/voice 路径</p>
    </div>
    ...
    <div class="card">
      <div class="controls">
        <button class="btn primary" @click="showVoiceAgent">打开语音客服</button>
      </div>
    </div>
...
const config = computed<BytedeskConfig>(() => ({
  ...
  autoPopup: false,
  draggable: true,
  bubbleConfig: { show: true, icon: '🎙️', title: 'AI语音客服', subtitle: '点击开始语音对话' },
